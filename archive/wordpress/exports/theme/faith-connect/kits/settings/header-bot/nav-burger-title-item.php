...
/**
 * Header Bot Navigation Burger Title Item settings.
 */
class Nav_Burger_Title_Item extends Settings_Tab_Base {
	...
	public static function get_toggle_name() {
		return 'header_bot_nav_burger_title_item';
	}
	...
	public function get_title() {
		return esc_html__( 'Hamburger Navigation Title Item', 'faith-connect' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_controls_group( 'nav_burger_title_item', self::CONTROLS_NAV_ITEM, array(
			'states' => array(
