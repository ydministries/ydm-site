...
/**
 * Header Mid Navigation Burger Button settings.
 */
class Nav_Burger_Button extends Settings_Tab_Base {
	...
	public static function get_toggle_name() {
		return 'header_mid_nav_burger_button';
	}
	...
	public function get_title() {
		return esc_html__( 'Hamburger Navigation Button', 'faith-connect' );
	}
	...
	protected function register_toggle_controls() {
		$this->add_controls_group( 'nav_burger_button', self::CONTROLS_ICON, array(
			'states' => array(
