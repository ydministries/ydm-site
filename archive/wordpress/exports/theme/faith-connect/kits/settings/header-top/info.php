 ...
 */
class Info extends Settings_Tab_Base {
	...
	public function get_title() {
		return esc_html__( 'Short Info', 'faith-connect' );
	}
	...
	protected function get_toggle_conditions() {
		return array(
			'condition' => array(
				...
				$this->get_control_id_parameter( '', 'elements' ) => 'info',
			),
		);
	}
	...
	protected function register_toggle_controls() {
		$this->add_controls_group( 'info', self::CONTROLS_SHORT_INFO );
	}
