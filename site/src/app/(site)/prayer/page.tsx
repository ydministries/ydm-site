...
const PAGE_KEY = "prayer_requests";
  ...
  return (
    <ContentProviderWrapper pageKey={PAGE_KEY} entries={contentEntries}>
      <AssetProviderWrapper entries={assetEntries}>
        ...
        {/* section: intro */}
        <section>
          <EditableContent fieldKey="intro.title" as="h2" />
        ...
        <section>
          ...
          <EditableContent fieldKey="form.field.request_label" as="p" />
          <EditableContent fieldKey="form.field.share_label" as="p" />
        ...
        {/* section: wall */}
        <section>
          <EditableContent fieldKey="wall.title" as="h2" />
          <EditableContent fieldKey="wall.empty_state" as="p" />
        </section>
