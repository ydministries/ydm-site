...
export default async function EventsPagePage() {
    ...
    <ContentProviderWrapper pageKey={PAGE_KEY} entries={contentEntries}>
      <AssetProviderWrapper entries={assetEntries}>
        ...
        <section>
          ...
          <EditableContent fieldKey="list.filter_services.label" as="p" />
          <EditableContent fieldKey="list.filter_studies.label" as="p" />
        </section>
