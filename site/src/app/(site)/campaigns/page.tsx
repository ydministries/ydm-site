...
export default async function OurCampaignsPage() {
  ...
  return (
    <ContentProviderWrapper pageKey={PAGE_KEY} entries={contentEntries}>
      <AssetProviderWrapper entries={assetEntries}>
        ...
        {/* section: other_ways */}
        <section>
          <EditableContent fieldKey="other_ways.title" as="h2" />
          <EditableContent fieldKey="other_ways.inperson.label" as="p" />
          <EditableRichText fieldKey="other_ways.inperson.body" />
          <EditableContent fieldKey="other_ways.mail.label" as="p" />
          <EditableRichText fieldKey="other_ways.mail.body" />
          <EditableContent fieldKey="other_ways.monthly.label" as="p" />
          <EditableRichText fieldKey="other_ways.monthly.body" />
        </section>
        {/* section: thank_you */}
        <section>
          <EditableContent fieldKey="thank_you.line" as="p" />
        </section>
