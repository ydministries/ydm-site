...
import { MinistryTemplate } from "@/components/templates/MinistryTemplate";

const PAGE_KEY = "ministries.partnership";
...
export default async function MinistriesPartnershipPage() {
  ...
  return (
    <ContentProviderWrapper pageKey={PAGE_KEY} entries={contentEntries}>
      <AssetProviderWrapper entries={assetEntries}>
        <MinistryTemplate pageKey={PAGE_KEY} />
